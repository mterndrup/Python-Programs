...
parent_dir = ("/mnt/c/Users/ketgl/OneDrive/Documents/GitHub/Python-Programs/BioTech"
              "/Bioinformatics/Tribal-Medicine/Cacti/DNA_Sequences")
...
for foldername in os.listdir(parent_dir):
    ...
    if os.path.isdir(folderpath) and foldername.startswith("barcode"):
        ...
        for filename in os.listdir(folderpath):
            if filename.endswith("_PITS.fasta"):
